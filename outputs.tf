...
output "ampls_private_dns_zone_ids" {
  description = "The name of the Private DNS zones within Azure DNS"
  value       = module.mod_ampls_main_private_endpoint.0.private_dns_zones_ids
}
